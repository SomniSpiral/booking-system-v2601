        ...
        <main id="main" style="padding-top: 50px;">
            ...
            <div class="card bg-transparent shadow-none pt-0"
                ...
                <div class="card-body">
                    <!-- Skeleton Loading -->
                    <div id="loadingState">
                        <!-- Keep your existing skeleton loading HTML exactly as is -->
                        <div class="row g-3">
                    ...
                    <div id="contentState" style="display: none;">
                                    ...
                                    <div class="card-body py-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center">
                                                <code id="requestIdTitle" class="request-code me-2"></code>
                                            </div>
                        ...
                        <div class="row g-2 mb-3">
                            <div class="col-3">
                                <div class="card text-center">
                                    <div class="card-body p-2">
                                        <div class="text-success"><i class="fa fa-thumbs-up"></i></div>
                                        <div class="fw-bold" id="approvalsCount">0</div>
                            ...
                            <div class="col-3">
                                <div class="card text-center">
                                    <div class="card-body p-2">
                                        <div class="text-danger"><i class="fa fa-thumbs-down"></i></div>
                                        <div class="fw-bold" id="rejectionsCount">0</div>
                            ...
                            <div class="col-3">
                                <div class="card text-center">
                                    <div class="card-body p-2">
                                        ...
                                        <div class="fw-bold" id="totalApprovedFee">0</div>
                        ...
                        <!-- Approvals and Rejections Modals (keep these here) -->
                        ...
                        <!-- Action Buttons Grid (unchanged) -->
                        <div class="row g-2 mb-2">
                            <div class="col-6">
                                <button class="btn btn-success w-100 py-2" id="approveBtn">
                                    <i class="bi bi-hand-thumbs-up me-1"></i> Approve
                                </button>
                            </div>
                            <div class="col-6">
                                <button class="btn btn-danger w-100 py-2" id="rejectBtn">
                                    <i class="bi bi-hand-thumbs-down me-1"></i> Reject
                                </button>
                            </div>
                            <div class="col-6">
                                <button class="btn btn-primary w-100 py-2" id="finalizeBtn" style="display: none;">
                                    <i class="bi bi-check-circle me-1"></i> Finalize
                                </button>
                            </div>
                            <div class="col-6">
                                <div class="dropdown w-100" id="moreActionsDropdown">
                                    <button class="btn btn-secondary bg-secondary-subtle text-dark w-100 py-2 dropdown-toggle"
                                        type="button" id="moreActionsBtn" data-bs-toggle="dropdown">
                                        <i class="bi bi-three-dots me-1"></i> More
                                    </button>
                                    <ul class="dropdown-menu w-100">
                                        <li><a class="dropdown-item status-option" id="statusScheduled" data-value="Scheduled"
                                                href="#"><i class="bi bi-calendar-event me-2"></i> Mark Scheduled</a></li>
                                        <li><a class="dropdown-item status-option" id="statusOngoing" data-value="Ongoing"
                                                href="#"><i class="bi bi-play-circle me-2"></i> Mark Ongoing</a></li>
                                        <li><a class="dropdown-item status-option" id="statusLate" data-value="Late" href="#"><i
                                                    class="bi bi-exclamation-circle me-2"></i> Mark Late</a></li>
                                        <li><a class="dropdown-item" id="closeForm" href="#"><i class="bi bi-x-circle me-2"></i>
                                                Close Form</a></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row g-2 mb-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card mb-2">
                                    <div class="card-header bg-white" data-bs-toggle="collapse" data-bs-target="#contactSection"
                                        style="cursor: pointer;">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h6 class="mb-0"><i class="bi bi-person-circle me-2"></i>Contact Information</h6>
                                            <i class="bi bi-chevron-down"></i>
                                        </div>
                                    </div>
                                    <div class="collapse show" id="contactSection">
                                        <div class="card-body p-2">
                                ...
                                <!-- Requested Items Section (NEW - separated by type) -->
                                <div class="card mb-2">
                                    <div class="card-header bg-white" data-bs-toggle="collapse"
                                        data-bs-target="#requestedItemsSection" style="cursor: pointer;">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h6 class="mb-0"><i class="bi bi-box-seam me-2"></i>Requested Items</h6>
                                            <i class="bi bi-chevron-down"></i>
                                        </div>
                                    </div>
                                    <div class="collapse show" id="requestedItemsSection">
                                        <div class="card-body p-2">
                                            <!-- Requested Venues -->
                                            <h6 class="fw-bold mb-2" style="font-size:0.9rem;">
                                                <i class="bi bi-building me-1"></i> Requested Venues
                                            </h6>
                                            <div id="requestedVenues" class="mb-3">
                                                <!-- Will be populated by JavaScript -->
                                            </div>

                                            <!-- Requested Equipment -->
                                            <h6 class="fw-bold mb-2" style="font-size:0.9rem;">
                                                <i class="bi bi-tools me-1"></i> Requested Equipment
                                            </h6>
                                            <div id="requestedEquipment">
                                                <!-- Will be populated by JavaScript -->
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card mb-2">
                                    <div class="card-header bg-white" data-bs-toggle="collapse"
                                        data-bs-target="#documentsSection" style="cursor: pointer;">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h6 class="mb-0"><i class="bi bi-file-earmark me-2"></i>Documents</h6>
                                            <i class="bi bi-chevron-down"></i>
                                        </div>
                                    </div>
                                    <div class="collapse show" id="documentsSection">
                                        <div class="card-body p-2">
                                            <div class="row g-1">
                                                <!-- Formal Letter -->
                                                <div class="col-6">
                                                    <div class="card text-center">
                                                        <div class="card-body p-2">
                                                            ...
                                                            <div class="small">Formal Letter</div>
                                                            <div id="formalLetterDocument" class="mt-1"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- Facility Layout -->
                                                <div class="col-6">
                                                    <div class="card text-center">
                                                        <div class="card-body p-2">
                                                            ...
                                                            <div class="small">Facility Layout</div>
                                                            <div id="facilityLayoutDocument" class="mt-1"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- Proof of Payment -->
                                                <div class="col-6">
                                                    <div class="card text-center">
                                                        <div class="card-body p-2">
                                                            ...
                                                            <div class="small">Payment Confirmation</div>
                                                            <div id="proofOfPaymentDocument" class="mt-1"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- Official Receipt -->
                                                <div class="col-6">
                                                    <div class="card text-center">
                                                        <div class="card-body p-2">
                                                            ...
                                                            <div class="small">Transaction Record</div>
                                                            <div id="officialReceiptDocument" class="mt-1"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <!-- Activity & Approvals Section (MERGED) -->
                                <div class="card mb-2">
                                    <div class="card-header bg-white" data-bs-toggle="collapse"
                                        data-bs-target="#activityApprovalsSection" style="cursor: pointer;">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h6 class="mb-0"><i class="bi bi-clock-history me-2"></i>Activity & Approvals</h6>
                                            <div class="d-flex align-items-center">
                                                <select id="activityFilter" class="form-select form-select-sm me-2"
                                                    style="width: auto;" onclick="event.stopPropagation()">
                                    ...
                                    <div class="collapse show" id="activityApprovalsSection">
                                        <div class="card-body p-2">

                                            <!-- Approval/Rejection Summary Pills (clickable) -->
                                            <div class="d-flex gap-2 mb-3">
                                                <div class="status-pill px-3 py-1 bg-success-subtle text-success rounded-pill d-inline-flex align-items-center hover-pointer"
                                                    ...
                                                    <span class="fw-bold me-2">0</span> <!-- REMOVED ID -->
                                                    <span>Approvals</span>
                                                </div>
                                            ...
                                            <div class="d-flex align-items-center mt-3">
                                                <textarea class="form-control me-2" rows="1" placeholder="Leave a comment..."
                                                    id="commentTextarea"
                        ...
                        <div class="card mb-2">
                            <div class="card-header bg-white" data-bs-toggle="collapse" data-bs-target="#bookingSection"
                                style="cursor: pointer;">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <button class="btn btn-sm btn-outline-primary me-2" onclick="event.stopPropagation();"
                                            data-bs-toggle="modal" data-bs-target="#calendarModal">
                                            <i class="bi bi-calendar-week me-1"></i> Schedule Calendar
                                        </button>
                                        <i class="bi bi-chevron-down"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="collapse show" id="bookingSection">
                                <div class="card-body p-2">
                        ...
                        <!-- Fee Breakdown Section (unchanged, full width) -->
                        <div class="card mb-2">
                            <div class="card-header bg-white" data-bs-toggle="collapse" data-bs-target="#feeSection"
                                style="cursor: pointer;">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0"><i class="bi bi-cash-stack me-2"></i>Fee Breakdown</h6>
                                    <div class="d-flex align-items-center">
                            ...
                            <div class="collapse show" id="feeSection">
                                <div class="card-body p-2">
                                    <div class="mb-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center fw-bold p-2 bg-light rounded">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-muted small">Finalizing this request will change its status from
                                    "Pending
                                    Approval" to "Awaiting Payment". This action cannot be undone and will prevent
                                    further
                                    approvals/rejections for signatories.</p>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control text-secondary" id="modalCalendarTitle"
                                                readonly>
                                        </div>
                                        <div class="mb-0">
                                            <label class="form-label fw-bold d-flex align-items-center mb-2">
                                            ...
                                            <td style="border: 1px solid #dee2e6; padding: 0;">
                                                <table class="table mb-0 w-100" style="border-collapse: collapse;">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <th class="bg-light text-nowrap p-2"
                                                                style="border-right: 1px solid #dee2e6;">Approvals
                                                            </th>
                                                            <td id="modalApprovals" class="p-2"></td>
                                                        </tr>
                                                        <tr>
                                                            <th class="bg-light text-nowrap p-2"
                                                                style="border-right: 1px solid #dee2e6;">Rejections
                                                            </th>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="text-center">
                                ...
                                <p class="text-muted small">This will mark the form as completed. This action cannot
                                    be undone.
                                </p>
                            </div>
                        </div>
            ...
            <div class="modal fade" id="markScheduledModal" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Are you sure you want to mark this request as scheduled? This will generate an
                                official receipt.
                            </p>
                            <div class="mb-3">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function setupCommentListeners() {
                ...
                if (!commentTextarea || !commentSendBtn) {
                    console.log('Comment elements not ready yet');
                    return false;
                }
            ...
            async function fetchRequestDetails() {
                try {
                    ...
                    // Setup comment listeners now that content is visible
            setupCommentListeners();
                        ...
                        // Requested Venues
        const venuesContainer = document.getElementById('requestedVenues');
        if (venuesContainer) {
            if (request.requested_items.facilities && request.requested_items.facilities.length > 0) {
                venuesContainer.innerHTML = request.requested_items.facilities.map(f =>
                    `<div class="d-flex align-items-center mb-2" style="padding:0 0.5rem;">
                        <span class="item-name">${f.name}</span>
                    </div>`
                ).join('');
            } else {
                venuesContainer.innerHTML = '<div class="text-muted small p-2">No venues requested</div>';
            }
        }

        // Requested Equipment
        const equipmentContainer = document.getElementById('requestedEquipment');
        if (equipmentContainer) {
            if (request.requested_items.equipment && request.requested_items.equipment.length > 0) {
                equipmentContainer.innerHTML = request.requested_items.equipment.map(e =>
                    `<div class="d-flex align-items-center mb-2" style="padding:0 0.5rem;">
                        <span class="item-name">${e.name} ${e.quantity > 1 ? `(×${e.quantity})` : ''}</span>
                    </div>`
                ).join('');
            } else {
                equipmentContainer.innerHTML = '<div class="text-muted small p-2">No equipment requested</div>';
            }
        }
